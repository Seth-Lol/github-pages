  ...
  app.innerHTML = `
    ...
    <section class="section statistics-section">
      <div class="shell">
        ...
        <div class="stats-grid portal-stats"><article class="stat"><span class="stat-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg></span><strong>${language === 'en' ? '125,575' : '១២៥ ៥៧៥ នាក់'}</strong><span>${language === 'en' ? 'Total candidates' : 'បេក្ខជនចូលរួមប្រឡងសរុប'}</span></article><article class="stat"><span class="stat-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="m8 12 2.5 2.5L16 9"/></svg></span><strong>${language === 'en' ? '84,06' : '៨៤ ០៦ នាក់'}</strong><span>${language === 'en' ? 'Total successful candidates' : 'បេក្ខជនជាប់សរុប'}</span></article><article class="stat"><span class="stat-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m12 3 2.7 5.5 6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1-4.4-4.3 6.1-.9Z"/></svg></span><strong>${language === 'en' ? '2,022 candidates' : '២ ០២២ នាក់'}</strong><span>${language === 'en' ? 'Grade A' : 'និទ្ទេស A'}</span></article></div>
      </div>
    </section>
